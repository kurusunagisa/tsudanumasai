...
})({"i4rc2":[function(require,module,exports) {
"use strict";
...
module.bundle.HMR_BUNDLE_ID = "dc65df7f88365fba";
...
/** textalive-app-api v0.3.2 | Copyright 2021 AIST TextAlive Project <textalive-ml@aist.go.jp> (https://textalive.jp) */ var _axios = require("axios");
...
function U(t, e, r) {
    ...
    return "undefined" == typeof window || !(null === (n = null === window || void 0 === window ? void 0 : window.navigator) || void 0 === n ? void 0 : n.userAgent) || window.navigator.userAgent.includes("Node.js") || window.navigator.userAgent.includes("jsdom") ? function(t, e, r) {
        ...
        try {
            ...
            console.error("failed to call lyrics parser", t, e1);
        }
    }));
}
    ...
    return t.prototype.wrap = function(t) {
            ...
            var s = function(t) {
                return function(e) {
                    try {
                        ...
                        r.throwException(r.URI_ERROR, t1.message);
                    }
                };
            }(i[o][0]);
        ...
        r = function(e) {
            ...
            try {
                ...
                n.throwException(n.SYNTAX_ERROR, "Invalid code: " + t1.message);
            }
        ...
        r = function(t) {
            try {
                ...
                n.throwException(n.ERROR, t1.message);
            }
        ...
        var n = function(t) {
            try {
                ...
                e.throwException(e.SYNTAX_ERROR, t1.message);
            }
        ...
        this.setProperty(r, "parse", this.createNativeFunction(n, !1)), n = function(t) {
            ...
            try {
                ...
                e.throwException(e.TYPE_ERROR, t1.message);
            }
            return n;
            ...
            if (o.eval) {
                ...
                if ("string" == typeof d) {
                    try {
                        ...
                        this.throwException(this.SYNTAX_ERROR, "Invalid code: " + t1.message);
                    }
...
var nn = {
    ...
    return t.prototype.initialize = function() {
        ...
        if (i) {
            var o1 = new Error("timeout: spent too long time (> " + t + "ms) to " + e);
            throw r.stateStack.length > 0 && (o1.node = r.stateStack[0].node), o1;
        }
...
var Pi = wi(1, .3 * 1.5), Ei = Object.freeze({
    ...
    return Object.defineProperty(t.prototype, "verbose", {
        ...
        try {
            ...
            return console.error("restoring templates failed", t1), !1;
        }
        return !0;
...
},{"axios":"jo6P5","cee49e87f31b05f0":"ca79R","6f79f0b28854126b":"lBnvK","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"jo6P5":[function(require,module,exports) {
...
},{}],"ca79R":[function(require,module,exports) {
module.exports = require("./helpers/browser/js-loader")(require("./helpers/bundle-url").getBundleURL("iVaJh") + "main.fb82e34c.js" + "?" + Date.now()).catch((err)=>{
...
},{}],"lBnvK":[function(require,module,exports) {
module.exports = require("./helpers/browser/js-loader")(require("./helpers/bundle-url").getBundleURL("iVaJh") + "webfontloader.3fa77979.js" + "?" + Date.now()).catch((err)=>{
    delete module.bundle.cache[module.id];
    throw err;
...
},{}]},["i4rc2","8lqZg"], "8lqZg", "parcelRequire0842")

//# sourceMappingURL=index.88365fba.js.map
